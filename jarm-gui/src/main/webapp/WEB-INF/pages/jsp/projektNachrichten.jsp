...
<h1 style = "padding: 5px; bottom: 300px; left: 0px; right: 0px; background-color: #c0c0c0;">Projektinterne Nachrichten
<i style="font-size:24px" class="fa">&#xf0e6;</i></h1>
     <div style = "padding: 5px; bottom: 25px; left: 5px; right: 5px; background-color: white; height:280px;">
	 ...
	 <div style = "padding: 5px; bottom: 30px; left: 0; right: 0; background-color: #c0c0c0;"> 
