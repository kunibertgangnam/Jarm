...
public class DatabaseTests {
	...
	public static void main(String[] args) {
		...
		User u1 = new User("Jonas", "123", "jonas@web.de");
		User u2 = new User("Magdalena", "123", "magdalena@web.de");
		User u3 = new User("Andreas", "123", "andreas@web.de");
		User u4 = new User("Ronja", "123", "ronja@web.de");
